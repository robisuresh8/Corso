...
$routes->group('student', ['filter' => 'jwtauth'], function($routes) {
    ...
    $routes->get('quiz', 'Student\QuizController::index');
    $routes->post('quiz/start', 'Student\QuizController::start');
    $routes->post('quiz/submit', 'Student\QuizController::submit');
...
// -----------------------------
// ADMIN API (for admin panel frontend: api/admin/stats etc.)
// -----------------------------
